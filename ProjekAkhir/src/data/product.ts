...
import type { RentalItem } from '../types'; // Import tipe dari file types.ts

export const allRentalProducts: RentalItem[] = [
  // --- Gunung-Jaya Bikes (ID 101) ---
  {
    ...
    image: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=600&h=400&fit=crop', rating: 4.8, reviews: 342, trending: true, price: 'Rp 50.000', period: '/hari', location: 'Jakarta Selatan',
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1591542858288-348873cce2b1?w=600&h=400&fit=crop', rating: 4.7, reviews: 150, trending: false, price: 'Rp 15.000', period: '/hari', location: 'Jakarta Selatan',
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1580128637393-0c4d1a45a1d0?w=400&h=300&fit=crop', rating: 4.6, reviews: 95, trending: false, price: 'Rp 45.000', period: '/hari', location: 'Jakarta Selatan',
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1621682498516-1f79a83a41b7?w=400&h=300&fit=crop', rating: 4.5, reviews: 112, trending: false, price: 'Rp 10.000', period: '/hari', location: 'Jakarta Selatan',
  },
   {
     ...
     image: 'https://plus.unsplash.com/premium_photo-1681487814165-018f15d4e1c9?w=400&h=300&fit=crop', rating: 4.4, reviews: 88, trending: false, price: 'Rp 8.000', period: '/hari', location: 'Jakarta Selatan',
   },
   {
     ...
     image: 'https://images.unsplash.com/photo-1599945452842-3a8f9b8b5277?w=400&h=300&fit=crop', rating: 4.6, reviews: 130, trending: false, price: 'Rp 12.000', period: '/hari', location: 'Jakarta Selatan',
   },
   {
     ...
     image: 'https://images.unsplash.com/photo-1570530734033-531e2e92c0a9?w=400&h=300&fit=crop', rating: 4.5, reviews: 75, trending: false, price: 'Rp 9.000', period: '/hari', location: 'Jakarta Selatan',
   },
   {
     ...
     image: 'https://images.unsplash.com/photo-1601643157091-ce5c665179ab?w=400&h=300&fit=crop', rating: 4.8, reviews: 210, trending: true, price: 'Rp 5.000', period: '/hari', location: 'Jakarta Selatan',
   },
   {
     ...
     image: 'https://plus.unsplash.com/premium_photo-1679497500057-3f3006d9fa2e?w=400&h=300&fit=crop', rating: 4.7, reviews: 90, trending: false, price: 'Rp 20.000', period: '/hari', location: 'Jakarta Selatan',
   },
   {
     ...
     image: 'https://images.unsplash.com/photo-1596521711204-5f992f9603f9?w=400&h=300&fit=crop', rating: 4.9, reviews: 180, trending: true, price: 'Rp 30.000', period: '/hari', location: 'Jakarta Selatan',
   },
  ...
  // --- DSLR World Rent (ID 102) ---
  {
    ...
    image: 'https://images.unsplash.com/photo-1606986628025-35d57e735ae0?w=600&h=400&fit=crop', rating: 4.9, reviews: 521, trending: true, price: 'Rp 150.000', period: '/hari', location: 'Jakarta Pusat',
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1512756290469-ec264b7fbf87?w=600&h=400&fit=crop', rating: 4.9, reviews: 310, trending: true, price: 'Rp 100.000', period: '/hari', location: 'Jakarta Pusat',
  },
  {
      ...
      image: 'https://images.unsplash.com/photo-1581457611388-941d34c11f43?w=400&h=300&fit=crop', rating: 4.7, reviews: 250, trending: true, price: 'Rp 35.000', period: '/hari', location: 'Jakarta Pusat',
  },
  {
      ...
      image: 'https://images.unsplash.com/photo-1614741128041-9caf60f3d64c?w=400&h=300&fit=crop', rating: 4.6, reviews: 180, trending: false, price: 'Rp 40.000', period: '/hari', location: 'Jakarta Pusat',
  },
  {
      ...
      image: 'https://images.unsplash.com/photo-1505230366404-bf2410a85375?w=400&h=300&fit=crop', rating: 4.8, reviews: 280, trending: true, price: 'Rp 90.000', period: '/hari', location: 'Jakarta Pusat',
  },
  {
      ...
      image: 'https://images.unsplash.com/photo-1614149299109-2719c89eb315?w=400&h=300&fit=crop', rating: 4.9, reviews: 400, trending: true, price: 'Rp 20.000', period: '/hari', location: 'Jakarta Pusat',
  },
  {
      ...
      image: 'https://images.unsplash.com/photo-1580910864104-e537e596a208?w=400&h=300&fit=crop', rating: 4.7, reviews: 190, trending: false, price: 'Rp 50.000', period: '/hari', location: 'Jakarta Pusat',
  },
  {
      ...
      image: 'https://plus.unsplash.com/premium_photo-1679497500120-d9c0255c2d3c?w=400&h=300&fit=crop', rating: 4.5, reviews: 110, trending: false, price: 'Rp 15.000', period: '/hari', location: 'Jakarta Pusat',
  },
  {
      ...
      image: 'https://images.unsplash.com/photo-1599528776824-343d548b8c9d?w=400&h=300&fit=crop', rating: 4.9, reviews: 610, trending: true, price: 'Rp 250.000', period: '/hari', location: 'Jakarta Pusat',
  },
  {
      ...
      image: 'https://images.unsplash.com/photo-1606791146824-4f9bfd2f8d8a?w=400&h=300&fit=crop', rating: 4.8, reviews: 350, trending: false, price: 'Rp 25.000', period: '/hari', location: 'Jakarta Pusat',
  },
  ...
  // --- TendaCamping-Shop (ID 103) ---
  {
    ...
    image: 'https://images.unsplash.com/photo-1478131143081-80f7f84ca84d?w=600&h=400&fit=crop', rating: 4.7, reviews: 189, trending: false, price: 'Rp 75.000', period: '/malam', location: 'Bogor',
  },
   {
      ...
      image: 'https://images.unsplash.com/photo-1589182373726-e4f658ab50f0?w=400&h=300&fit=crop', rating: 4.6, reviews: 120, trending: true, price: 'Rp 25.000', period: '/malam', location: 'Bogor',
   },
   {
      ...
      image: 'https://images.unsplash.com/photo-1517942621871-417a1a0f91e4?w=400&h=300&fit=crop', rating: 4.8, reviews: 210, trending: true, price: 'Rp 20.000', period: '/hari', location: 'Bogor',
   },
   {
      ...
      image: 'https://images.unsplash.com/photo-1628994759681-a99f6764426f?w=400&h=300&fit=crop', rating: 4.5, reviews: 160, trending: false, price: 'Rp 10.000', period: '/malam', location: 'Bogor',
   },
   {
      ...
      image: 'https://images.unsplash.com/photo-1594943906378-79d23a4a1599?w=400&h=300&fit=crop', rating: 4.6, reviews: 140, trending: true, price: 'Rp 12.000', period: '/malam', location: 'Bogor',
   },
   {
      ...
      image: 'https://images.unsplash.com/photo-1596281898499-a9a3b6d0d5b4?w=400&h=300&fit=crop', rating: 4.7, reviews: 195, trending: false, price: 'Rp 15.000', period: '/hari', location: 'Bogor',
   },
   {
      ...
      image: 'https://images.unsplash.com/photo-1579847127045-6a4a131c92d5?w=400&h=300&fit=crop', rating: 4.8, reviews: 220, trending: true, price: 'Rp 50.000', period: '/hari', location: 'Bogor',
   },
   {
      ...
      image: 'https://images.unsplash.com/photo-1558985141-ff0dff000a6e?w=400&h=300&fit=crop', rating: 4.6, reviews: 115, trending: false, price: 'Rp 18.000', period: '/hari', location: 'Bogor',
   },
   {
      ...
      image: 'https://images.unsplash.com/photo-1605721865918-9c6a11756b2c?w=400&h=300&fit=crop', rating: 4.9, reviews: 280, trending: true, price: 'Rp 15.000', period: '/malam', location: 'Bogor',
   },
   {
      ...
      image: 'https://images.unsplash.com/photo-1550953686-3f1a070902c4?w=400&h=300&fit=crop', rating: 4.7, reviews: 170, trending: false, price: 'Rp 22.000', period: '/hari', location: 'Bogor',
   },
  ...
  // --- Gamer Gear ID (ID 104) ---
  {
    ...
    image: 'https://images.unsplash.com/photo-1517336714731-489689fd1ca8?w=600&h=400&fit=crop', rating: 4.6, reviews: 215, trending: true, price: 'Rp 200.000', period: '/hari', location: 'Jakarta Timur',
  },
   {
      ...
      image: 'https://images.unsplash.com/photo-1615663245841-d5d1c32688d3?w=400&h=300&fit=crop', rating: 4.8, reviews: 180, trending: true, price: 'Rp 30.000', period: '/hari', location: 'Jakarta Timur',
   },
   {
      ...
      image: 'https://images.unsplash.com/photo-1601467075935-73f15c4033e5?w=400&h=300&fit=crop', rating: 4.7, reviews: 155, trending: false, price: 'Rp 40.000', period: '/hari', location: 'Jakarta Timur',
   },
   {
      ...
      image: 'https://images.unsplash.com/photo-1585298723682-711556143f71?w=400&h=300&fit=crop', rating: 4.8, reviews: 205, trending: true, price: 'Rp 50.000', period: '/hari', location: 'Jakarta Timur',
   },
   {
      ...
      image: 'https://images.unsplash.com/photo-1593640495253-23196b27a7c9?w=400&h=300&fit=crop', rating: 4.7, reviews: 190, trending: false, price: 'Rp 80.000', period: '/hari', location: 'Jakarta Timur',
   },
   {
      ...
      image: 'https://images.unsplash.com/photo-1616487198599-2a13f63e6e7d?w=400&h=300&fit=crop', rating: 4.6, reviews: 140, trending: false, price: 'Rp 35.000', period: '/hari', location: 'Jakarta Timur',
   },
   {
      ...
      image: 'https://images.unsplash.com/photo-1600080972464-8e5f35f63d08?w=400&h=300&fit=crop', rating: 4.9, reviews: 250, trending: true, price: 'Rp 45.000', period: '/hari', location: 'Jakarta Timur',
   },
   {
      ...
      image: 'https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=400&h=300&fit=crop', rating: 4.8, reviews: 160, trending: false, price: 'Rp 70.000', period: '/hari', location: 'Jakarta Timur',
   },
   {
      ...
      image: 'https://plus.unsplash.com/premium_photo-1681282200378-d56d4f6d45e2?w=400&h=300&fit=crop', rating: 4.5, reviews: 110, trending: false, price: 'Rp 15.000', period: '/hari', location: 'Jakarta Timur',
   },
   {
      ...
      image: 'https://images.unsplash.com/photo-1616499385536-39908851415b?w=400&h=300&fit=crop', rating: 4.9, reviews: 220, trending: true, price: 'Rp 60.000', period: '/hari', location: 'Jakarta Timur',
   },
];