...
// Helper Kategori (bisa dipindah ke src/utils/helpers.ts)
    ...
    <TouchableOpacity
      ...
      <TouchableOpacity
        ...
        {likesLoading ? (
          ...
          <Icon name="heart" size={18} color={isLiked ? COLORS.danger : 'white'} />
        )}
      </TouchableOpacity>
...
// Salin style yang relevan dari HomeScreen.tsx
